...
def serializedATN():
    return [
        ...
        36,0,0,12,14,1,0,0,0,13,10,1,0,0,0,14,15,1,0,0,0,15,13,1,0,0,0,15,
        16,1,0,0,0,16,1,1,0,0,0,17,18,5,4,0,0,18,21,5,21,0,0,19,20,5,16,
        0,0,20,22,5,21,0,0,21,19,1,0,0,0,21,22,1,0,0,0,22,23,1,0,0,0,23,
        29,5,41,0,0,24,25,3,4,2,0,25,26,5,36,0,0,26,28,1,0,0,0,27,24,1,0,
        0,0,28,31,1,0,0,0,29,27,1,0,0,0,29,30,1,0,0,0,30,32,1,0,0,0,31,29,
        1,0,0,0,32,33,5,42,0,0,33,3,1,0,0,0,34,35,5,22,0,0,35,44,5,39,0,
        0,36,41,3,6,3,0,37,38,5,38,0,0,38,40,3,6,3,0,39,37,1,0,0,0,40,43,
        1,0,0,0,41,39,1,0,0,0,41,42,1,0,0,0,42,45,1,0,0,0,43,41,1,0,0,0,
        44,36,1,0,0,0,44,45,1,0,0,0,45,46,1,0,0,0,46,47,5,40,0,0,47,48,5,
        35,0,0,48,49,5,21,0,0,49,50,5,41,0,0,50,51,3,8,4,0,51,52,5,42,0,
        0,52,61,1,0,0,0,53,54,5,22,0,0,54,55,5,35,0,0,55,58,5,21,0,0,56,
        57,5,34,0,0,57,59,3,8,4,0,58,56,1,0,0,0,58,59,1,0,0,0,59,61,1,0,
        0,0,60,34,1,0,0,0,60,53,1,0,0,0,61,5,1,0,0,0,62,63,5,22,0,0,63,64,
        5,35,0,0,64,65,5,21,0,0,65,7,1,0,0,0,66,67,6,4,-1,0,67,68,5,22,0,
        0,68,69,5,34,0,0,69,149,3,8,4,26,70,71,5,22,0,0,71,80,5,39,0,0,72,
        77,3,8,4,0,73,74,5,38,0,0,74,76,3,8,4,0,75,73,1,0,0,0,76,79,1,0,
        0,0,77,75,1,0,0,0,77,78,1,0,0,0,78,81,1,0,0,0,79,77,1,0,0,0,80,72,
        1,0,0,0,80,81,1,0,0,0,81,82,1,0,0,0,82,149,5,40,0,0,83,84,5,5,0,
        ...
        5,41,0,0,98,99,3,8,4,0,99,100,5,36,0,0,100,102,1,0,0,0,101,98,1,
        0,0,0,102,103,1,0,0,0,103,101,1,0,0,0,103,104,1,0,0,0,104,105,1,
        0,0,0,105,106,5,42,0,0,106,149,1,0,0,0,107,108,5,18,0,0,108,109,
        5,22,0,0,109,110,5,35,0,0,110,113,5,21,0,0,111,112,5,34,0,0,112,
        114,3,8,4,0,113,111,1,0,0,0,113,114,1,0,0,0,114,125,1,0,0,0,115,
        116,5,38,0,0,116,117,5,22,0,0,117,118,5,35,0,0,118,121,5,21,0,0,
        119,120,5,34,0,0,120,122,3,8,4,0,121,119,1,0,0,0,121,122,1,0,0,0,
        ...
        129,149,3,8,4,20,130,131,5,19,0,0,131,149,5,21,0,0,132,133,5,17,
        0,0,133,149,3,8,4,18,134,135,5,15,0,0,135,149,3,8,4,9,136,137,5,
        33,0,0,137,149,3,8,4,8,138,139,5,39,0,0,139,140,3,8,4,0,140,141,
        5,40,0,0,141,149,1,0,0,0,142,149,5,22,0,0,143,149,5,21,0,0,144,149,
        ...
        0,0,149,195,1,0,0,0,150,151,10,17,0,0,151,152,5,23,0,0,152,194,3,
        8,4,18,153,154,10,16,0,0,154,155,5,24,0,0,155,194,3,8,4,17,156,157,
        10,15,0,0,157,158,5,25,0,0,158,194,3,8,4,16,159,160,10,14,0,0,160,
        161,5,26,0,0,161,194,3,8,4,15,162,163,10,13,0,0,163,164,5,27,0,0,
        164,194,3,8,4,14,165,166,10,12,0,0,166,167,5,28,0,0,167,194,3,8,
        4,13,168,169,10,11,0,0,169,170,5,29,0,0,170,194,3,8,4,12,171,172,
        10,10,0,0,172,173,5,30,0,0,173,194,3,8,4,11,174,177,10,25,0,0,175,
        176,5,20,0,0,176,178,5,21,0,0,177,175,1,0,0,0,177,178,1,0,0,0,178,
        179,1,0,0,0,179,180,5,37,0,0,180,181,5,22,0,0,181,190,5,39,0,0,182,
        187,3,8,4,0,183,184,5,38,0,0,184,186,3,8,4,0,185,183,1,0,0,0,186,
        ...
        194,5,40,0,0,193,150,1,0,0,0,193,153,1,0,0,0,193,156,1,0,0,0,193,
...
class YALPParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "'_'", "'class'", 
                     ...
                     "'pool'", "'true'", "'false'", "'in'", "'not'", "'inherits'", 
                     "'isvoid'", "'let'", "'new'", "'@'", "<INVALID>", "<INVALID>", 
                     "'+'", "'-'", "'*'", "'/'", "'%'", "'<'", "'<='", "'='", 
                     "'&&'", "'||'", "'~'", "'<-'", "':'", "';'", "'.'", 
                     "','", "'('", "')'", "'{'", "'}'", "'['", "']'" ]
    ...
    symbolicNames = [ "<INVALID>", "INTEGER", "STRING", "ANY", "CLASS", 
                      ...
                      "TRUE", "FALSE", "IN", "NOT", "INHERITS", "ISVOID", 
                      "LET", "NEW", "SIGN", "TYPE_ID", "OBJECT_ID", "PLUS", 
                      "MINUS", "TIMES", "DIVIDE", "MOD", "LESS_THAN", "LESS_EQUAL", 
                      "EQUAL", "AND", "OR", "NEGATE", "ASSIGN", "COLON", 
                      "SEMICOLON", "DOT", "COMMA", "LPAREN", "RPAREN", "LBRACE", 
                      "RBRACE", "LBRAKE", "RBRAKE", "WS", "COMMENT", "LARGE_COMMENT" ]
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & 2757376258598) != 0):
                    self.state = 72
                    self.expr(0)
                    self.state = 77
                    self._errHandler.sync(self)
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & 2757376258598) != 0)):
                        break
